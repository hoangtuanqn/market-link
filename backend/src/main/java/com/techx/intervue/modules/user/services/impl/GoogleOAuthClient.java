...
/**
 * Google OAuth2 authorization code flow: exchange the code (using client_secret) for an id_token,
 * then verify the id_token ourselves with Google's public key — never trust any token the frontend
 * sends.
 */
@Component
public class GoogleOAuthClient {
    ...
    public GoogleOAuthClient(RestClient oauthRestClient, OAuthProperties properties) {
        ...
        // Downloads + caches the JWKS itself, checks the RS256 signature; also checks exp/nbf,
        // issuer and audience
    ...
    /**
     * The URL of the Google sign-in page. client_id and redirect_uri come from app.oauth.google so
     * they always match those used when fetchProfile exchanges the code. state is generated by the
     * frontend and checked by it on the callback page (anti- CSRF).
     */
    ...
    public SocialProfile fetchProfile(String code) {
        ...
        TokenResponse tokens =
                restClient
                        ...
                        .body(form)
                        .retrieve()
                        // the code is wrong / already used / expired, or redirect_uri does not
                        // match
                        .onStatus(
        ...
        // Google sometimes returns email_verified as a boolean, sometimes as the string "true"
