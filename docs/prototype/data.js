...
(function (PT) {
  ...
  PT.farmers = [
    ...
    { id: 7, stall: 'U Minh Nuts & Grains', person: 'Huỳnh Văn Tài', phone: '0919 880 114', email: 'matong@example.com', markets: [3, 4], days: 'Wed, Sat', pickup: '06:30 – 10:00', rating: 4.7, reviews: 27, distance: '9.8 km', approval: 'approved', cutoffHours: 24, lat: 10.729, lng: 106.7193, stallCode: 'C05', registered: '25/08/2026', about: 'Peanuts, cashews and black sesame, dried and sorted by hand in U Minh.' },
    ...
    { id: 12, stall: 'Củ Chi Free-range Poultry', person: 'Trịnh Văn Dũng', phone: '0912 707 415', email: 'gaduc@example.com', markets: [2, 3], days: 'Sat, Sun', pickup: '06:00 – 09:30', rating: 4.5, reviews: 14, distance: '4.1 km', approval: 'approved', cutoffHours: 18, lat: 10.8505, lng: 106.7715, stallCode: 'B11', registered: '18/08/2026', about: 'Chickens and ducks raised on a Củ Chi orchard, slaughtered the morning of market day.' },
    { id: 13, stall: 'Cần Giờ Seafood', person: 'Nguyễn Thị Hồng', phone: '0908 554 126', email: 'hongcangio@example.com', markets: [3, 4], days: 'Wed, Sat', pickup: '06:30 – 10:00', rating: 4.6, reviews: 22, distance: '9.8 km', approval: 'approved', cutoffHours: 18, lat: 10.7288, lng: 106.7188, stallCode: 'C08', registered: '28/08/2026', about: 'Prawns, clams and river fish brought up from Cần Giờ the night before.' },
  ];
  ...
  PT.products = [
    ...
    { id: 5, name: 'Sourdough loaf', farmer: 4, cat: 8, price: 45000, unit: 'loaf', stock: 15, flag: 'Baked at 5am', status: 'available', desc: '800 g country loaf, 24-hour ferment. Crust is dark on purpose.' },
    { id: 6, name: 'Free-range eggs', farmer: 5, cat: 3, price: 42000, unit: 'dozen', stock: 20, status: 'available', desc: 'Mixed sizes from hens on pasture. Laid within the last 3 days.' },
    { id: 7, name: 'Thai basil', farmer: 1, cat: 1, price: 8000, unit: 'bunch', stock: 30, status: 'available', desc: 'Large bunch, about 150 g.' },
    ...
    { id: 10, name: 'Rye loaf', farmer: 4, cat: 8, price: 55000, unit: 'loaf', stock: 3, status: 'available', desc: '900 g, 60 percent rye. Slices best the day after baking.' },
    { id: 11, name: 'Cinnamon rolls', farmer: 4, cat: 8, price: 25000, unit: 'piece', stock: 0, status: 'unavailable', desc: 'Not baked this week. Back when the oven is repaired.' },
    ...
    { id: 14, name: 'Roasted peanuts', farmer: 7, cat: 4, price: 180000, unit: 'jar', stock: 9, status: 'available', desc: '500 ml. Unfiltered, may crystallise in the fridge.' },
    { id: 15, name: 'Cashew nuts', farmer: 7, cat: 4, price: 120000, unit: 'jar', stock: 4, status: 'available', desc: '200 g. Store dry and away from light.' },
    ...
    { id: 19, name: 'Lemongrass', farmer: 1, cat: 1, price: 6000, unit: 'bunch', stock: 22, status: 'available', desc: 'Bunch of 6 stalks.' },
    ...
    { id: 23, name: 'Elephant garlic', farmer: 6, cat: 1, price: 25000, unit: 'bulb', stock: 40, status: 'available', desc: 'One large bulb, milder than ordinary garlic. Keeps for weeks in a dry place.' },
    { id: 24, name: 'Duck eggs', farmer: 5, cat: 3, price: 95000, unit: 'tray of 30', plural: 'trays of 30', stock: 12, status: 'available', desc: 'Laid this week. Sold by the tray; we do not split them.' },
    ...
    { id: 26, name: 'Morning glory, wild', farmer: 1, cat: 1, price: 20000, unit: 'bunch', stock: 0, status: 'unavailable', desc: 'Foraged, not farmed — only listed when there is enough for a full week.' },
    { id: 27, name: 'Whole free-range chicken', farmer: 12, cat: 5, price: 320000, unit: 'piece', stock: 8, status: 'available', desc: 'About 1.6 kg, raised on an orchard in Củ Chi. Cleaned and chilled on market morning.' },
    { id: 28, name: 'Chicken legs', farmer: 12, cat: 5, price: 150000, unit: 'kg', stock: 10, status: 'available', desc: 'From the same free-range birds. Sold by weight, bone in.' },
    { id: 29, name: 'Duck', farmer: 12, cat: 5, price: 130000, unit: 'kg', stock: 6, status: 'available', desc: 'Grazed on the rice field behind the orchard. Ask for it jointed if you want.' },
    { id: 30, name: 'Tiger prawns', farmer: 13, cat: 6, price: 320000, unit: 'kg', stock: 7, flag: 'Caught last night', status: 'available', desc: 'Brought up from Cần Giờ overnight and kept on ice. About 30 to a kilo.' },
    { id: 31, name: 'Snakehead fish', farmer: 13, cat: 6, price: 140000, unit: 'kg', stock: 9, status: 'available', desc: 'River-caught, sold whole. Cleaned at the stall while you wait.' },
    { id: 32, name: 'Clams', farmer: 13, cat: 6, price: 45000, unit: 'kg', stock: 20, status: 'available', desc: 'Rinsed and left in salt water overnight so they spit the sand out.' },
  ];
  ...
  PT.platformRevenue = {
    ...
    byStall: [
      ...
      { stall: 'U Minh Nuts & Grains', spent: 259000, share: 'Extra listings and bumps', orders: 46 },
