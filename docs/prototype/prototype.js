...
(function (PT) {
  ...
  /* Buying controls written straight into a page rather than generated by a component. Marking them
     ...
     set of actions the server has to refuse as well (FR-005, and Definition of Done item 3: "Check
     permissions (role + ownership) on the server, not just hiding the button in the FE"). */
